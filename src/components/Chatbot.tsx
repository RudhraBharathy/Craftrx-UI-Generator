...
const Chatbot: React.FC<ChatbotProps> = ({ onGenerate }) => {
  ...
  >([
    {
      role: "ai",
      content:
        "Hello! I'm your UI component generator. Describe the component you want to create, and I'll generate it for you.",
    },
  ]);
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        { role: "ai", content: "Generating component..." },
      ]);
      ...
      setMessages((prev) => [
        ...prev.slice(0, -1),
        {
          role: "ai",
          content:
            "I've generated your component based on your description. You can see it in the preview panel and customize it further if needed.",
        },
      ]);
      ...
      setMessages((prev) => [
        ...prev.slice(0, -1),
        {
          role: "ai",
          content:
            "Sorry, I encountered an error generating your component. Please try again with a different description.",
        },
      ]);
